...
public class PlayVideo {
    ...
    private String secondVideoPath = "/home/villasilvia/Desktop/condivisa/videoPlayer/contessa.mp4";
    ...
    private String mpvSocketPath = null;
    ...
    private void showThumbnail() throws InterruptedException {
        ...
        System.out.println("Mostro schermo nero");
        ...
        loadMpv(activeVideoPath);

    }

    private void loadMpv(String videoPath) {
        if (videoPath != null) {
            try {
                if (videoPath.equals(secondVideoPath)) {
                    mpvSocketPath = "/tmp/mpvsocket2";
                } else {
                ...
                ProcessBuilder pb = new ProcessBuilder(
                        ...
                        videoPath);
                System.out.println("mpv avviato in pausa e in ascolto su " + mpvSocketPath);
    ...
    private void sendMpvCommand(String jsonCommand) {
        try {
            ...
            String[] command = {
                    "bash",
                    "-c",
                    "echo '" + escapedJson + "' | socat - " + mpvSocketPath
            };
